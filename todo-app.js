(function () {
  ...
  // создаем и возвращаем дело и список элементов
  function createTodoItem(obj) {
    ...
    // устанавливаемые стили для элемента списка, а также для размещения кнопок
  ...
  // функция которая ищет максимальный id в массиве и прибалвяет + 1
